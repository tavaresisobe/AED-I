...
void vetorAno(tipoListaEE *l, int *vetorAno, int count, int posicao)
{
  int i, j ;
  if (count == 0)
  {
    vetorAno[count] =  l ->elemento[posicao].valor ;
  }else
  {
    for (i = 0 ; i <= count ; i++)
    {
      j = 0 ;
      if (l ->elemento[posicao].valor == vetorAno[i])
      {
        j++ ;
      }
    }
...
void ano_de_ingresso(tipoListaEE *l, int *ra)
{
  int i = 0, j = l->primeiro ;
  int y2011 = 0, y2012 = 0, y2013 = 0, y2014 = 0, y2015 = 0, y2016 = 0, y2017 = 0, y2018 = 0 ;
